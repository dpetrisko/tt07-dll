...
class BsgChipTagClients:
    def __init__(self):
        ...
        ##########################
        self.params = Object()
        self.params.osc_num_rows = (
                2,
                "Number of rows for oscillator"
                )
        self.params.osc_num_cols = (
                2,
        ...
        self.params.osc_ctl_width = (
                int(math.log2(self.params.osc_num_taps[0])),
                "Width of control regs for oscillator"
                )
        self.params.osc_post_buf = (
                2,
                "Length of post oscillator buffer chain"
                )
        self.params.osc_ds_width = (
                2,
                "Width of oscillator downsampler"
                )
        self.params.dly_num_rows = (
                2,
                "Number of rows for delay line"
                )
        self.params.dly_num_cols = (
                2,
        ...
        self.params.dly_ctl_width = (
                int(math.log2(self.params.dly_num_taps[0])),
                "Width of control regs for delay line"
                )
        self.params.dly_post_buf = (
                4,
                "Length of post delay buffer chain"
                )
        self.params.dly_count_width = (
                8,
        ...
        self.clients.osc.ctl = (i,
                self.params.osc_ctl_width[0],
                "Programmable control for oscillator"
                ); i+=1
        self.clients.osc.trigger = (i,
                1,
                "Trigger for oscillator"
                ); i+=1
        self.clients.osc.ds = (i,
                self.params.osc_ds_width[0]+1,
                "Downsampler width"
                ); i+=1
        self.clients.osc.sel = (i,
                2,
        ...
        self.clients.mon.reset = (i,
                1,
                "Synchronous reset"
                ); i+=1
        self.clients.mon.sel = (i,
                2,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gentype", type=str, choices=["pkg", "param"], required=True, help="Which collateral")
