...
class BsgChipPkg:
    def __init__(self):
        ...
        self.params.osc_num_rows = (8, "Number of rows for oscillator")
        self.params.osc_num_cols = (8, "Number of cols for oscillator")
        ...
        self.params.dly_num_rows = (8, "Number of rows for delay line")
        self.params.dly_num_cols = (8, "Number of cols for delay line")
        ...
        self.params.dly_post_buf = (4, "Length of post delay buffer chain")
